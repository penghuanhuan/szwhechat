      ...
      <div class="content-wrapper">
        ...
        <div class="cotent-detail">
          ...
          <div class="content-table">
            ...
            >
              <el-table-column prop="Name" fixed :cell-style="{color:'red'}" label="街道办" align="center" ></el-table-column>
...
export default {
  ...
  created () {
    ...
    this.wxApi.getwxUser().then(() => {
      ...
      this.cantonCode = getQueryString('cantonCode')
  ...
  methods: {
    ...
    getData () {
      this.tableData = []
      this.CommonAccountBaseController.GetCommonAccountCenseList(this.userInfo.OpenId, this.cantonCode, this.type).then(res => {
    ...
    goNextSteps (row, column, cell) {
      ...
      switch (column.label) {
        ...
        case '项目总数（个）':
          ...
          break
        default:
          window.location.href = `../accountStreet/accountStreet.html?streetCode=${row.Code}&type=3`
          break
      }
    },
    handleClose () {
...
<style lang="scss" scoped src="./accountCanton.scss">
