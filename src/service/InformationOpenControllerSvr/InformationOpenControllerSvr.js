...
export class InformationOpenControllerSvr {
  ...
  getOwnerCommitteeByCode (openId, eaAreaCode) {
    return request.post(this.baseurl + 'getOwnerCommitteeByCode', Qs.stringify({
      openId: openId,
  ...
  getProjectDetails (openId, projectDetailsID) {
    return request.post(this.baseurl + 'getProjectDetails', Qs.stringify({
      openId: openId,
  ...
  getEmployeeByCode (openId, eaAreaCode) {
    return request.post(this.baseurl + 'getEmployeeByCode', Qs.stringify({
      openId: openId,
      eaAreaCode: eaAreaCode
    }))
  }
  ...
  getEmployeeDetail (openId, employeeNumber) {
    return request.post(this.baseurl + 'getEmployeeDetail', Qs.stringify({
      openId: openId,
  ...
  /**
   *
   * openId:String, orgCode:String, empName:String, startIndex:int, maxSize:int
   */
  getEmployeeByOrgCode (openId, orgCode, empName, startIndex, maxSize) {
    return request.post(this.baseurl + 'getEmployeeByOrgCode', Qs.stringify({
      openId: openId,
      orgCode: orgCode,
      empName: empName,
  ...
  /**
   *
   * openId:String, orgCode:String, projectName:String, startIndex:int, maxSize:int
   */
  getPrejectList (openId, orgCode, projectName, startIndex, maxSize) {
  ...
  getPrejectDetailList (openId, areaName, cantonName, startIndex, maxSize) {
    return request.post(this.baseurl + 'getPrejectDetailList', Qs.stringify({
      openId: openId,
      areaName: areaName,
